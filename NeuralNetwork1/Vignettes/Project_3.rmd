...
matpoints(x = dot.x,
          ...
          pch = 19)
```
For the above graph "NNetEarlyStoppingCV Prostate", the Blue line is the validation set error, and Redline is the Test set error. With a step.size of :

,and

number of n.hidden.units, the optimal number of steps found was:
...
,and
number of n.hidden.units, the optimal number of steps found was: 
. by tweaking these values, a more optimal solution might be possible.
