...
> [Binary Classification](#nn.bc)
> [Linear Regression](#nn.lr)
...
- Written with w and v: $$\mathcal{L}(w,v) = \frac{1}{2}\sum_{i=1}^n[w^TS(V^Tx_i) - y_i]$$ |where $$S[a] = frac{1}{1+e^(-ax)}$$
- Log Loss: $$L(f(x),y_i) = \sum_{i=1}^n[log(1+exp(-y_i f(x_i))]$$
