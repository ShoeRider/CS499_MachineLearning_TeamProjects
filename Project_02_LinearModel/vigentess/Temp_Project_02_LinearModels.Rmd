...
```{r}
# !!for some Reason I cant get code to run but here is some example code how to use LMSquareLossIterations!!
...
#--------------------LMSquareLossEarlyStoppingCV------------------------
  LMSquareLossES_Weights<- LMSquareLossEarlyStoppingCV(TrainingLabels, TrainingData, fold.vec,Folds,30)
...
#--------------------LMSquareLossIterations------------------------
  ...
  LMSquareLoss_Error <-Find_Wmatrix_MeanL2Error(TrainingLabels, TrainingData,LMSquareLoss_Weights,BinaryClassification)
...
#--------------------LMSquareLossEarlyStoppingCV------------------------
  #Find the Error for each Iteration:
  LMSquareLossES_Error <-Find_Wmatrix_MeanL2Error(TrainingLabels, TrainingData,LMSquareLossES_Weights,BinaryClassification)

  #Here is a Matrix of the Error of each iteration of the weight Matrix:
  print(LMSquareLossES_Error)
  
  #Here is a plot the weight Matrix found with LMSquareLossIterations:
  #barplot(LMSquareLossES_Error,main = "LMSquareLossEarlyStoppingCV Vs Error \n 'Library'spam",xlab = "mean loss value",beside = TRUE)
#------------------------------------------------------------------------
```
