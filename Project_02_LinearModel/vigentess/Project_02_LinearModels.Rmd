...
author: "Anthony Schroeder,Chadd Frasier"
date: ""
...
for(i in 1:(LossMat.fold.n))
{
  ...
  if(TRUE)
  {
    ...
    SL_L2.TrainError.Vec <-Find_Wmatrix_MeanL1Error(testData[,1:NCOL(testData)-1],testData[,NCOL(testData)],Spam$BinaryClassification)
...
####-------------------------LMSquareLossL2penalties-(SL_L2_Error_Pen)----------------------
```{r}
  #Question: 4
...
####-------------------------LMSquareLossL2CV_List-(SL_L2CV_Error)----------------------
```{r}
  #Question:5
...
```{r}
  plot(rowMeans(as.matrix(SLI.TrainError.Mat)),type="o", col = "blue", xlab = "Iterations", ylab = "Error",main = "")
...
```{r}
  plot(as.matrix((SL_L2.TestError.Mat[2:NROW(SL_L2.TestError.Mat)])),type="o", col = "blue", xlab = "Iterations", ylab = "Error",main = "")
...
for(i in 1:(LossMat.fold.n))
{
  ...
  plot(rowMeans(as.matrix(SLI.TrainError.Mat)),type="o", col = "blue", xlab = "Iterations", ylab = "Error",main = "KNN wrt Selected K, ElemStatLearn::SAheart\n L1(red),L2(blue)")
  lines(rowMeans(as.matrix(SLI.TestError.Mat)),type="o", col = "red")
...
####--------------------LMSquareLossEarlyStoppingCV (ES_CV_Error)-----------
```{r}
  #Question:2   print("Linear_SAheart_Tests: Question:2")
LossMat.fold.n  <- 4
LossMat.fold.vec<-as.matrix(Random_Folds((SAheart$n_Elements),LossMat.fold.n))
Data = cbind(SAheart$TrainingData ,SAheart$TrainingLabels)
#Randomly shuffle the data
#Data<-Data[sample(nrow(Data)),]
ES_CV_Error.WholeError.Mat = 0
...
print(SL_L2.TrainError.Mat)
  ...
  plot(as.matrix((SL_L2.TestError.Mat[2:NROW(SL_L2.TestError.Mat)])),type="o", col = "blue", xlab = "Iterations", ylab = "Error",main = "KNN wrt Selected K, ElemStatLearn::SAheart\n L1(red),L2(blue)")
  plot(as.matrix(SL_L2.TrainError.Mat[2:NROW(SL_L2.TrainError.Mat)]),type="o", col = "red", xlab = "Iterations", ylab = "Error",main = "KNN wrt Selected K, ElemStatLearn::SAheart\n L1(red),L2(blue)")
...
for(i in 1:(LossMat.fold.n))
{
  ...
  plot(rowMeans(as.matrix(SLI.TrainError.Mat)),type="o", col = "blue", xlab = "Iterations", ylab = "Error",main = "KNN wrt Selected K, ElemStatLearn::ZipTrain\n L1(red),L2(blue)")
  lines(rowMeans(as.matrix(SLI.TestError.Mat)),type="o", col = "red")
...
####--------------------LMSquareLossEarlyStoppingCV (ES_CV_Error)-----------
```{r}
  #Question:2   print("Linear_ZipTrain_Tests: Question:2")
LossMat.fold.n  <- 4
LossMat.fold.vec<-as.matrix(Random_Folds((ZipTrain$n_Elements),LossMat.fold.n))
Data = cbind(ZipTrain$TrainingData ,ZipTrain$TrainingLabels)
#Randomly shuffle the data
#Data<-Data[sample(nrow(Data)),]
ES_CV_Error.WholeError.Mat = 0
...
print(SL_L2.TrainError.Mat)
  ...
  plot(as.matrix((SL_L2.TestError.Mat[2:NROW(SL_L2.TestError.Mat)])),type="o", col = "blue", xlab = "Iterations", ylab = "Error",main = "KNN wrt Selected K, ElemStatLearn::ZipTrain\n L1(red),L2(blue)")
  plot(as.matrix(SL_L2.TrainError.Mat[2:NROW(SL_L2.TrainError.Mat)]),type="o", col = "red", xlab = "Iterations", ylab = "Error",main = "KNN wrt Selected K, ElemStatLearn::ZipTrain\n L1(red),L2(blue)")
  #lines(as.matrix(SL_L2.TrainError.Mat[2:NROW(SL_L2.TrainError.Mat)]),type="o", col = "red")
```
...
####--------------------LMSquareLossEarlyStoppingCV (ES_CV_Error)-----------
```{r}
  #Question:2   print("Linear_Prostate_Tests: Question:2")
LossMat.fold.n  <- 4
LossMat.fold.vec<-as.matrix(Random_Folds((Prostate$n_Elements),LossMat.fold.n))
Data = cbind(Prostate$TrainingData ,Prostate$TrainingLabels)
#Randomly shuffle the data
#Data<-Data[sample(nrow(Data)),]
ES_CV_Error.WholeError.Mat = 0
...
print(SL_L2.TrainError.Mat)
  ...
  plot(as.matrix((SL_L2.TestError.Mat[2:NROW(SL_L2.TestError.Mat)])),type="o", col = "blue", xlab = "Iterations", ylab = "Error",main = "KNN wrt Selected K, ElemStatLearn::Prostate\n L1(red),L2(blue)")
  plot(as.matrix(SL_L2.TrainError.Mat[2:NROW(SL_L2.TrainError.Mat)]),type="o", col = "red", xlab = "Iterations", ylab = "Error",main = "KNN wrt Selected K, ElemStatLearn::Prostate\n L1(red),L2(blue)")
  #lines(as.matrix(SL_L2.TrainError.Mat[2:NROW(SL_L2.TrainError.Mat)]),type="o", col = "red")
```
