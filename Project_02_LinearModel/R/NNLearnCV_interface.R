...
#'      train.loss.mat     = Is a [folds.n x max.neighbors] matrix containing the Loss values for each fold, and the train.loss.vec is just the colMeans of this matrix
